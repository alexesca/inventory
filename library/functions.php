...
function buildProductDetails($img, $name, $description, $price, $stock, $size, $weight, $location, $vendor, $style){
  ...
  <div class="right">
    ...
    <p id="price">$$price</p>
    <p class="details"><strong>Stock: </strong>$stock</p>
    <p class="details"><strong>Size: </strong>$size</p>
    <p class="details"><strong>Weight: </strong>$weight</p>
    <p class="details"><strong>location: </strong>$location</p>
    <p class="details"><strong>Vendor: </strong>$vendor</p>
    <p class="details"><strong>Style: </strong>$style</p>
  </div>
</div>
EOD;
